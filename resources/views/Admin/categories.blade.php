...
<!-- Modal toggle -->
<button data-modal-target="progress-modal" data-modal-toggle="progress-modal" class="block text-white bg-blue-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
    ADD
  </button>
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="p-4 md:p-5">
                  ...
                  <h3 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">Add New Categoy</h3>
        ...
        <h1 class="p-5" style="font-size:1.5em; font-family: 'Oswald', sans-serif;">LIST OF YOUR CATEGORIES</h1>

        <div class="w-1/2 mt-12 p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="flex flex-wrap"></div>
            
            @foreach ($categories as $categorie)
            <div class="w-full text-slate-900 bg-slate-200 w-1/2">
                <div class="container flex items-center justify-between px-6 py-4 mx-auto">
                    <div class="flex gap-48">
                        ...
                        <div class="flex gap-8">
                            <button data-modal-target="modal{{$categorie->id}}" data-modal-toggle="modal{{$categorie->id}}"
                                        ...
                                        <div class="p-4 md:p-5 text-left">
                                            ...
                                            <form action="{{ route('categorie.update', $categorie->id) }}" method="post">
                                                ...
                                                <div class="col-span-2 mt-2">
                                                    ...
                                                    <input type="text" name="name" id="name"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="Type event name" required="" value="{{$categorie->name}}">
                            ...
                            <form class="mt-1" action="{{ route('categorie.destroy', $categorie->id) }}" method="post">
                                @csrf
                                @method('DELETE')
