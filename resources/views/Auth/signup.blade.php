        ...
        <div class=" grid md:grid-cols-2 items-center gap-8 h-full">
            <form class="max-w-lg max-md:mx-auto w-full p-6" action="{{ route('signup') }}" method="POST">
                ...
                <div class="mt-6">
                    ...
                    <div class="relative flex items-center">
                        <input name="email" type="text" id="email-field" required onkeyup="validateEmail()"
                            class="w-full text-sm bg-gray-100 px-4 py-4 rounded-md outline-blue-600"
                ...
                <div class="mt-6">
                    ...
                    <div class="relative flex items-center">
                        <input name="password" type="password" required id="password-field" onkeyup="validatePassword()"
                            class="w-full text-sm bg-gray-100 px-4 py-4 rounded-md outline-blue-600"
